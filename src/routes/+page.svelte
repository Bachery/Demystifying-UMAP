...
<svelte:head>
	<title>Demystifying UMAP | Interactive 3D Probes</title>
</svelte:head>

<div
	class="flex h-screen w-screen flex-col overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(219,234,254,0.85),_transparent_30%),linear-gradient(180deg,_#f8fafc_0%,_#eef4ff_100%)] font-sans text-gray-800"
>
	<Header />

	<main class="flex min-h-0 flex-1 overflow-hidden">
		<div
			class="relative z-10 flex h-full w-96 shrink-0 flex-col border-r border-gray-200/50 bg-white/60 shadow-[4px_0_24px_rgba(0,0,0,0.05)] backdrop-blur-xl"
		>
		...
		<div
			class="relative flex min-w-0 flex-1 flex-col items-center justify-center overflow-hidden bg-slate-100/35 p-4"
		>
			{#if appState.dataset}
